...
<div class="modal fade" id="modalForm" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Subadmin Details</h4>
            </div>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
				<a href="addowner.php"><button class="btn btn-success">
   Add Subadmin
</button></a>
			<?php
					...
					foreach($cursor as $document)
			{
                ...
                <tr>
					<td><?php echo ++$id; ?></td>
                  <td>
						<?php if (!empty($document->first_name)) {
								 // do something
                  ...
                  <td>
						<?php if (!empty($document->last_name)) {
								 // do something
								 echo $document->last_name;
								}
						?>
				  </td>
				  <td>
                  ...
                  <td>
						<?php if (!empty($document->mobile)) {
								 // do something
								 echo $document->mobile;
								}
						?>
				  </td>
				   ...
				   <td>
						...
						<?php if (!empty($document->owner_status)) {
								 // do something
								
									 if ($document->owner_status=='1')
									 {
											 echo 'Active';
									 }
									 else
 ...
 <i class="fa fa-eye"></i> View
			 ...
			 <a href="editowner.php?id=<?php echo $document->_id;  ?>" title="Edit" style="margin-right:3%;margin-left:2%;" class="btn btn-info"><i class="fa fa-pencil-square"></i>  Edit</a>
		 ...
		 // Delete 
		  $('.delete').click(function(){
			...
			var con=confirm("Are You Sure to Delete");
					if(con==true)
					{
						window.location.href="deleteowner.php?id="+deleteid;
					}
					else
					{
						return false;
