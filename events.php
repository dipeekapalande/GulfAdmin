...
<div class="modal fade" id="modalForm" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Events Details</h4>
            </div>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
				<a href="addevent.php"><button class="btn btn-success">
   Add Event
</button></a>
			<?php
                ...
                <tr>
                  ...
                  <td>
				   ...
				   <td>
						...
						<?php if (!empty($document->event_status)) {
								 // do something
								
									 if ($document->event_status==true)
									 {
											 echo 'Active';
									 }
									 else
					...
					<td>
						<?php 
							...
							/*$as=array();
							$thestring = implode(", ", $alldates);
							echo $thestring;
							$as=explode(", ",$thestring);
							print_r($as);
							...
							*/
							foreach($alldates as $s)
							{
								$timestamp = $s->__toString();							
								$utcdatetime = new MongoDB\BSON\UTCDateTime($timestamp);
								$datetime = $utcdatetime->toDateTime();
								$time=$datetime->format(DATE_RSS);
							...
							?>
								<span class="label label-warning" style="font-size:12px;"><?=$dateInLocal?></span><br><br>
							<?php
 ...
 <i class="fa fa-eye"></i> View
			 ...
			 <a href="editevent.php?id=<?php echo $document->_id;  ?>" title="Edit" style="margin-right:3%;margin-left:2%;" class="btn btn-info"><i class="fa fa-pencil-square"></i>  Edit</a>
		 ...
		 // Delete 
		  $('.delete').click(function(){
			...
			var con=confirm("Are You Sure to Delete");
					if(con==true)
					{
						window.location.href="deleteevent.php?id="+deleteid;
					}
					else
					{
						return false;
