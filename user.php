...
<div class="modal fade" id="modalForm" role="dialog">
   ...
   Add User
					...
					foreach($cursor as $document)
			{
                ...
                <tr>
				  ...
				  <td>
						<?php if (!empty($document->email_id)) {
								 // do something
                  ...
                  <td>
				   ...
				   <td>
						...
						<?php if (!empty($document->user_status)) {
								 // do something
								
									 if ($document->user_status=='1')
									 {
											 echo 'Active';
									 }
									 else
 ...
 <i class="fa fa-eye"></i> View
			 ...
			 <a href="editbutton.php?id=<?php echo $document->_id;  ?>" title="Edit" style="margin-right:3%;margin-left:2%;" class="btn btn-info"><i class="fa fa-pencil-square"></i>  Edit</a>
			 
        <a onClick ='return confirm("Do you want to remove this
                     record?");' 
        href='deleteuser.php?id=<?php echo $document->_id;  ?>' class="btn btn-danger"><i class="fa fa-trash"></i>  Delete</td>
