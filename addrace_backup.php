	 ...
	 foreach($camellist as $c)
	 {
      ...
      if(!$camel_status){
        ...
        $flag = 5;
           ...
           $insRec->insert(['racename'=>$racename,'racedate'=>$d,'racetime'=>$t,'duration'=>$durationtime,'isTrending'=>$s,'length'=>(double)$length,'channelid'=>$channelid,'live_stream_urls'=>$urlarray,'camellist'=>$camellist22]);
            ...
            <div class="box-body">
				...
				<form enctype="multipart/form-data" method="POST">
                    <div class="form-group">
						...
						<div class="col-sm-6">
							<label for="status">Channel name</label>
						...
						<input type="text" class="form-control" placeholder="Search here..." name="keyword" id="keyword" required="required"  onkeyup="checkcamel()"/>
						
						<input type="text" name="camellist" class="camellist">
