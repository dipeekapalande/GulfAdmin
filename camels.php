...
<div class="modal fade" id="modalForm" role="dialog">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
				<a href="addcamel.php"><button class="btn btn-success">
   Add Camel / أضف الجمل
</button></a>
			<?php
					...
					foreach($cursor as $document)
			{
                ...
                <tr>
					<td><?php echo ++$id; ?></td>
					 <td>
						<?php if (!empty($document->camelname)) {
								 // do something
								 echo $document->camelname;
								}
						?>
                  ...
                  <td>
						<?php if (!empty($document->camelnumber)) {
								 // do something
								 echo $document->camelnumber;
								}
						?>
                  ...
                  <td>
						<?php if (!empty($document->cameldescription)) {
								 // do something
								 echo $document->cameldescription;
								}
						?>
				  </td>
				  <td>
						<?php if (!empty($document->camelcategory)) {
								 // do something
								 echo $document->camelcategory;
								}
						?>
				 </td>
 ...
 <i class="fa fa-eye"></i> View
			 ...
			 <a href="editcamel.php?id=<?php echo $document->_id;  ?>" title="Edit" style="margin-right:3%;margin-left:2%;" class="btn btn-info"><i class="fa fa-pencil-square"></i>  Edit</a>
