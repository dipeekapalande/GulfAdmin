    			    ...
    			    if(move_uploaded_file($imagePath,"images/".$newName))
    			    {
					  ...
					  if(!$channel_status){
						...
						$flag = 5;
						   ...
						   $insRec->insert(['channelheader'=>$channelheader,'channelsubheader'=>$channelsubheader,'location'=>$location,'channel_status' =>$s,'image'=>$newName,'eventname'=>$eventname,'coverimage'=>$newcoverName,'created_date'=>$d]);
            ...
            <div class="box-body">
				...
				<form enctype="multipart/form-data" method="POST">
                    <div class="form-group">
						...
						<div class="col-sm-6">
							<label class="control-label" for="inputPatient">Channel Cover Image</label>
							<div class="field desc">
								<input class="form-control" id="coverimage" name="coverimage" placeholder="coverimage" type="file" onchange="return validatecoverimage();"  required>
							</div>
						</div>
