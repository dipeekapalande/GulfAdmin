...
<div class="modal fade" id="modalForm" role="dialog">
 ...
 <i class="fa fa-eye"></i> Generate Result
</button> -->
			<?php if (!empty($document->resultstatus)) {
				if($document->resultstatus=='true')
				{
					
			?>
				<a href="generateraceresult.php?id=<?php echo $document->_id;  ?>" title="Edit" style="margin-right:3%;margin-left:2%;" class="btn btn-info"><i class="fa fa-eye-square"></i>  View Result</a>
			<?php
			}}else{
			?>
			 <a href="generateresult1.php?id=<?php echo $document->_id;  ?>" title="Edit" style="margin-right:3%;margin-left:2%;" class="btn btn-info"><i class="fa fa-pencil-square"></i>  Generate Result</a>
