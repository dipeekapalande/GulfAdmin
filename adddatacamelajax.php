...
$response .='
 <form role="form" enctype="multipart/form-data" id="modal_form_id"  method="POST">
<div class="form-group">
							<input type="hidden" class="form-control" id="uid" name="id" value=""/>
						
						<div class="col-sm-6">
							<label for="camelname">اسم الجمل/(Camel Name)</label>
							<input type="text" class="form-control" id="camelname" name="camelname" value=""  required />
						</div>
						<div class="col-sm-6">
							<label for="camelnumber">عدد الجمل/(Camel Number)</label>
							<input type="text" class="form-control" id="camelnumber" name="camelnumber" value=""  required />
						</div>
						<div class="col-sm-12">
							<label for="cameldescription">الجمل الوصف/(Camel Description)</label>
							<textarea class="form-control" id="cameldescription" name="cameldescription" value="" ></textarea>
						</div>
						<div class="col-sm-6">
						...
						<div class="col-sm-6">
							<label for="fathername">اسم الأب /(Fathers Name)</label>
							<input type="text" class="form-control" id="fathername" name="fathername" value=""  />
						</div>
						
						<div class="col-sm-6">
							<label for="mothername">اسم الأم / (Mothers Name)</label>
							<input type="text" class="form-control" id="mothername" name="mothername" value=""  />
						</div>
