	 ...
	 //Image Upload
      ...
      if(!$camel_status){
        ...
        $flag = 5;
           ...
           $insRec->insert(['camelname'=>$camelname,'camelnumber'=>$camelnumber,'cameldescription'=>$cameldescription,'camelcategory'=>$camelcategory,'age'=>(int)($age),'fathername'=>$fathername,'mothername'=>$mothername,'gender'=>$gender,'camel_status' =>$s,'image'=>$newName,'owner_name'=>$owner_name,'mobile'=>$ccode,'countryCode'=>$countryCode,'contact'=>$contact,'raceid'=>$raceid]);
            ...
            <div class="box-body">
				...
				<form enctype="multipart/form-data" method="POST">
                    <div class="form-group">
						...
						<div class="col-sm-6">
							<label for="camelnumber">Age</label>
							<input type="number" class="form-control" id="age" name="age" value="<?php if (!empty($row->age)) { echo $row->camelnumber;} else { echo "";}?>"  placeholder="Enter Age of Camel" required />
						</div>
						...
						<div class="col-sm-6">
							...
							<input type="text" class="form-control" id="fathername" name="fathername" value="<?php if (!empty($row->fathername)) { echo $row->fathername;} else { echo "";}?>"  placeholder="Enter Father Name" required />
						</div>
						
						<div class="col-sm-6">
							<label for="mothername">Mother's Name</label>
							<input type="text" class="form-control" id="mothername" name="mothername" value="<?php if (!empty($row->mothername)) { echo $row->mothername;} else { echo "";}?>"  placeholder="Enter Mother Name" required />
						</div>
						
						<div class="col-sm-6">
							<label class="control-label" for="inputPatient">Camels Picture</label>
						...
						<div class="col-sm-6">
							<label for="owner_name">Owner name</label>
								<input type="text" class="form-control" id="owner_name" name="owner_name" value="<?php if (!empty($row->owner_name)) { echo $row->owner_name;} else { echo "";}?>"  placeholder="Enter Owner Name" required />
	...
	<optgroup label="Other countries">
		...
		<option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
						...
						<div class="col-sm-6">
							...
							<input type="text" class="form-control" id="mobile" name="mobile" value="<?php if (!empty($row->mobile)) { echo $row->mobile;} else { echo "";}?>" maxlength="8" onkeypress="return onlyNumberKey(event)" placeholder="Enter Mobile Number" required />
						</div>
						
						<div class="col-sm-6">
							<label for="racename">Race Name</label>
								
							<select class="form-control" class="racename" id="select2" name="racename" class="required">
								<option value="" selected="">Select Race</option>
									<?php
									 $filter = ['_id' => new MongoDB\BSON\ObjectID($id)];
										...
										{
									?>
											<option value="<?php echo $document->_id;?>"><?php echo $document->racename;?></option>
									<?php
										}
									?>
